      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/games" 
              className="px-6 py-3 rounded-md bg-vibrant-orange-500 text-white text-base font-semibold hover:bg-vibrant-orange-600 transition-all duration-200 hover:scale-105 shadow-soft hover:shadow-medium"
            >
              Browse Games
            </Link>
            <Link 
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white rounded-lg shadow-soft p-4 hover:shadow-medium transition-shadow duration-200">
        ...
        {/* CTA Section */}
        <div className="bg-gradient-to-r from-vibrant-orange-500 to-warm-yellow-400 rounded-lg p-6 text-white">
          ...
          <Link 
            href="/games" 
            className="inline-block px-6 py-3 bg-white text-vibrant-orange-600 rounded-md font-semibold hover:bg-gray-50 transition-all duration-200 hover:scale-105 shadow-soft hover:shadow-medium"
          >
